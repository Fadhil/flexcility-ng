...
export class AdminDashboardComponent implements OnInit {
 // constructor( ) { }
  ...
  public ppmdoughnutChartLabels: string[] = ['In Completed', 'Completed'];
  public ppmdoughnutChartData: number[] = [350, 450];
  public ppmdoughnutChartType = 'doughnut';


  public scmdoughnutChartLabels: string[] = ['In Completed ', 'Completed'];
  public scmdoughnutChartData: number[] = [350, 100];
  public scmdoughnutChartType = 'doughnut';

  public cmDoughnutChartLabels: string[] = ['In completed', 'Completed'];
  public cmDoughnutChartData: number[] = [250, 400];
